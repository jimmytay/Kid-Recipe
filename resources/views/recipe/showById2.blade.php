...
<div class="row">
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <p class="card-text">
                  <strong><font color="blue">Ingredients</font></strong>: <br />{{ $recipes->ingredientTwo}}
              </p>
              <a class="btn btn-outline-primary" href="{{ URL::route('recipe.showById',$recipes['id'])}}" >Switch to pounds</a>
            </div>
<div class="col-sm-3">
            <p class="card-text">
